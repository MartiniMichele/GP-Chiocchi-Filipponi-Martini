...
path_results = os.path.abspath(os.path.join(source_dir, os.pardir)) + "/tRNA_csv/tRNA_csv/Results/LTP.xlsx"
...
df_results = None
columns = ['Organism name', 'Length', 'Benchmark ID', 'Taxonomy.LTP.superkingdom', 'Taxonomy.LTP.class',
           'Taxonomy.LTP.order']
df_results = rebuild_file(path_DB_archaea, columns, df_results)
df_results = rebuild_file(path_DB_bacteria1, columns, df_results)
df_results = rebuild_file(path_DB_bacteria2, columns, df_results)
df_results = rebuild_file(path_DB_bacteria3, columns, df_results)
df_results = rebuild_file(path_DB_bacteria4, columns, df_results)
