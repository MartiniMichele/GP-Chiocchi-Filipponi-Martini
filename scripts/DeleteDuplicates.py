...
path = os.path.abspath(os.path.join(source_dir, os.pardir)) + "/16S_csv/Results_notnull_phylum/SILVA.xlsx"
path_results = os.path.abspath(os.path.join(source_dir, os.pardir)) + "/16S_csv/Results_phylum_noduplicates/SILVA_phylum_noduplicates.xlsx"
