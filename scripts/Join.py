...
path_ENA_origin = os.path.abspath(os.path.join(source_dir, os.pardir)) + "/nh_16S_csv/Results_notnull_phylum/ENA.xlsx"
path_GTDB_origin = os.path.abspath(os.path.join(source_dir, os.pardir)) + "/nh_16S_csv/Results_notnull_phylum/GTDB.xlsx"
path_LTP_origin = os.path.abspath(os.path.join(source_dir, os.pardir)) + "/nh_16S_csv/Results_notnull_phylum/LTP.xlsx"
path_NCBI_origin = os.path.abspath(os.path.join(source_dir, os.pardir)) + "/nh_16S_csv/Results_notnull_phylum/NCBI.xlsx"
path_SILVA_origin = os.path.abspath(os.path.join(source_dir, os.pardir)) + "/nh_16S_csv/Results_notnull_phylum/SILVA.xlsx"
...
result_df.to_excel("C:/Users/fchio/Desktop/GroupProject/GP-Chiocchi-Filipponi-Martini/nh_16S_csv/Results_notnull_phylum/join.xlsx", index=False)